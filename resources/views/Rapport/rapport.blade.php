...
<head>
    ...
    <style>
        ...
        .needle {
            ...
            height: 50%;
            /* Hauteur de l'aiguille, ajustez selon vos besoins */
            ...
            /* L'aiguille commencera à 0 degré */
        ...
        @media print {
            ...
            body {
                margin: 1cm;
                /* Adjust this margin as necessary */
            }
        }
    </style>
...
<body style="padding: 1rem">
    ...
    <div class="card">
        ...
        <ul>
            <li><strong>Auditeurssssssss :</strong> : {{ $missionActulle->user->Nom }}
                {{ $missionActulle->user->Prenom }}</li>
            ...
            <li><strong>Réservation effectuée le (date et heure) :</strong>
                {{ $missionActulle->user->ReservationEffectuee }}</li>
            <li><strong>Canal de réservation (site web ou tél) :</strong> {{ $missionActulle->user->CanalReservation }}
            </li>
        </ul>
    </div>
                                ...
                                <div class="progress-container" style="flex: 1; display: flex; align-items: center;">
                                    <div class="progress-bar" style="width: 100%; background-color: #f3f3f3; border-radius: 5px;">
                                        <div class="colored-bar"
                                            style="width: {{ number_format($category_percentage, 2) }}%; background-color:
